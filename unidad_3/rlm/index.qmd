...
Una variable de confusión es una variable que distorsiona la medida de la asociación entre otras dos variables. El resultado en presencia de una variable de confusión puede ser la observación de:
